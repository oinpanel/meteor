...
import { notification, context, data, window } from '@oinpanel/meteor-admin-sdk';
import { SwButton, SwTextField, SwTextarea } from '@oinpanel/meteor-component-library';

const { repository, Classes: { Criteria } } = data;

export default defineComponent({
    mounted() {
        console.log('mounted main module');
    },
    components: {
        'sw-button': SwButton,
