...
```
npm i --save @oinpanel/meteor-admin-sdk
```

and import it in your app:
```js
// import everything
import * as sw from '@oinpanel/meteor-admin-sdk';

// or import only needed functionality
import { notification }  from '@oinpanel/meteor-admin-sdk';
```
...
<script src="https://unpkg.com/@oinpanel/meteor-admin-sdk/cdn"></script>

// use a fix version (example here: 1.2.3)
<script src="https://unpkg.com/@oinpanel/meteor-admin-sdk@1.2.3/cdn"></script>
```
