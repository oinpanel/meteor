...
- fc3c5a6: Reduce bundle size caused by font
  ...
  import "@oinpanel/meteor-component-library/dist/styles.css";
  ```
  ...
  ```js
  // Some JavaScript file: index.js
  import "@oinpanel/meteor-component-library/styles.css"; // Note: this path is different from the old one
